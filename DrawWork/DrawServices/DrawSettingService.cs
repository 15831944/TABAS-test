    ...
    public class DrawSettingService
    {
        ...
        public void CreateModelSpaceSample(Model singleModel)
        {
            ...
            if (true)
            {
                ...
                DDSService.CreateStructureModel();
                ...
                Point3D refPoint2 = new Point3D(80000, 1000, 0);
                DrawEntityModel structureOrin = DDSService.DrawDetailRoofStructureOrientation(refPoint2, singleModel, scaleValue,null);
